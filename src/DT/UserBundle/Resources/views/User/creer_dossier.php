<?php
	...
	afficheStructureDeb("Créer un dossier de suivi");
?>
	<div class="page-header borderColor">
		<h2>Créer un dossier de suivi </h2>
	</div>
	...
	<form class="border1px form-horizontal" style="padding:30px;" role="form">
		...
		<div class="form-group">
			<label for="enc_th" class="col-sm-3 control-label">Encadrant</label>
			<div class="col-sm-9">
				<input type="text" class="form-control" name="enc_th[]" placeholder="Encadrant de la thèse">
				<p id="plus_enc"> Ajouter un autre encadrant<b> + </b> </p>
			</div>
		</div>
